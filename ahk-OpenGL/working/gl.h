...
/* texture mapping */
GLAPI void APIENTRY glTexSubImage1D( unsigned int target, int level, int xoffset, int width, unsigned int format, unsigned int type, const void *pixels );
GLAPI void APIENTRY glTexSubImage2D( unsigned int target, int level, int xoffset, int yoffset, int width, int height, unsigned int format, unsigned int type, const void *pixels );
GLAPI void APIENTRY glCopyTexImage1D( unsigned int target, int level, unsigned int internalformat, int x, int y, int width, int border );
GLAPI void APIENTRY glCopyTexImage2D( unsigned int target, int level, unsigned int internalformat, int x, int y, int width, int height, int border );
GLAPI void APIENTRY glCopyTexSubImage1D( unsigned int target, int level, int xoffset, int x, int y, int width );
GLAPI void APIENTRY glCopyTexSubImage2D( unsigned int target, int level, int xoffset, int yoffset, int x, int y, int width, int height );
/* vertex arrays */
GLAPI void APIENTRY glVertexPointer( int size, unsigned int type, int stride, const void *ptr );
GLAPI void APIENTRY glNormalPointer( unsigned int type, int stride, const void *ptr );
GLAPI void APIENTRY glColorPointer( int size, unsigned int type, int stride, const void *ptr );
GLAPI void APIENTRY glIndexPointer( unsigned int type, int stride, const void *ptr );
GLAPI void APIENTRY glTexCoordPointer( int size, unsigned int type, int stride, const void *ptr );
GLAPI void APIENTRY glEdgeFlagPointer( int stride, const void *ptr );
GLAPI void APIENTRY glGetPointerv( unsigned int pname, void **params );
GLAPI void APIENTRY glArrayElement( int i );
GLAPI void APIENTRY glDrawArrays( unsigned int mode, int first, int count );
GLAPI void APIENTRY glDrawElements( unsigned int mode, int count, unsigned int type, const void *indices );
GLAPI void APIENTRY interleavedArrays( unsigned int format, int stride, const void *pointer );
...
/* 1.2 functions */
GLAPI void APIENTRY glDrawRangeElements( unsigned int mode, unsigned int start, unsigned int end, int count, unsigned int type, const void *indices );
GLAPI void APIENTRY glTexImage3D( unsigned int target, int level, unsigned int internalFormat, int width, int height, int depth, int border, unsigned int format, unsigned int type, const void *pixels );
GLAPI void APIENTRY glTexSubImage3D( unsigned int target, int level, int xoffset, int yoffset, int zoffset, int width, int height, int depth, unsigned int format, unsigned int type, const void *pixels);
GLAPI void APIENTRY glCopyTexSubImage3D( unsigned int target, int level, int xoffset, int yoffset, int zoffset, int x, int y, int width, int height );

/* 1.2 imaging extension functions */
GLAPI void APIENTRY glColorTable( unsigned int target, unsigned int internalformat, int width, unsigned int format, unsigned int type, const void *table );
GLAPI void APIENTRY glColorSubTable( unsigned int target, int start, int count, unsigned int format, unsigned int type, const void *data );
GLAPI void APIENTRY glColorTableParameteriv(unsigned int target, unsigned int pname, const int *params);
GLAPI void APIENTRY glColorTableParameterfv(unsigned int target, unsigned int pname, const float *params);
GLAPI void APIENTRY glCopyColorSubTable( unsigned int target, int start, int x, int y, int width );
GLAPI void APIENTRY glCopyColorTable( unsigned int target, unsigned int internalformat, int x, int y, int width );
GLAPI void APIENTRY glGetColorTable( unsigned int target, unsigned int format, unsigned int type, void *table );
GLAPI void APIENTRY glGetColorTableParameterfv( unsigned int target, unsigned int pname, float *params );
GLAPI void APIENTRY glGetColorTableParameteriv( unsigned int target, unsigned int pname, int *params );
GLAPI void APIENTRY glBlendEquation( unsigned int mode );
GLAPI void APIENTRY glBlendColor( float red, float green, float blue, float alpha );
GLAPI void APIENTRY glHistogram( unsigned int target, int width, unsigned int internalformat, unsigned char sink );
GLAPI void APIENTRY glResetHistogram( unsigned int target );
GLAPI void APIENTRY glGetHistogram( unsigned int target, unsigned char reset, unsigned int format, unsigned int type, void *values );
GLAPI void APIENTRY glGetHistogramParameterfv( unsigned int target, unsigned int pname, float *params );
GLAPI void APIENTRY glGetHistogramParameteriv( unsigned int target, unsigned int pname, int *params );
GLAPI void APIENTRY glMinmax( unsigned int target, unsigned int internalformat, unsigned char sink );
GLAPI void APIENTRY glResetMinmax( unsigned int target );
GLAPI void APIENTRY glGetMinmax( unsigned int target, unsigned char reset, unsigned int format, unsigned int types, void *values );
GLAPI void APIENTRY glGetMinmaxParameterfv( unsigned int target, unsigned int pname, float *params );
GLAPI void APIENTRY glGetMinmaxParameteriv( unsigned int target, unsigned int pname, int *params );
GLAPI void APIENTRY glConvolutionFilter1D( unsigned int target, unsigned int internalformat, int width, unsigned int format, unsigned int type, const void *image );
GLAPI void APIENTRY glConvolutionFilter2D( unsigned int target, unsigned int internalformat, int width, int height, unsigned int format, unsigned int type, const void *image );
GLAPI void APIENTRY glConvolutionParameterf( unsigned int target, unsigned int pname, float params );
GLAPI void APIENTRY glConvolutionParameterfv( unsigned int target, unsigned int pname, const float *params );
GLAPI void APIENTRY glConvolutionParameteri( unsigned int target, unsigned int pname, int params );
GLAPI void APIENTRY glConvolutionParameteriv( unsigned int target, unsigned int pname, const int *params );
GLAPI void APIENTRY glCopyConvolutionFilter1D( unsigned int target, unsigned int internalformat, int x, int y, int width );
GLAPI void APIENTRY glCopyConvolutionFilter2D( unsigned int target, unsigned int internalformat, int x, int y, int width, int height);
GLAPI void APIENTRY glGetConvolutionFilter( unsigned int target, unsigned int format, unsigned int type, void *image );
GLAPI void APIENTRY glGetConvolutionParameterfv( unsigned int target, unsigned int pname, float *params );
GLAPI void APIENTRY glGetConvolutionParameteriv( unsigned int target, unsigned int pname, int *params );
GLAPI void APIENTRY glSeparableFilter2D( unsigned int target, unsigned int internalformat, int width, int height, unsigned int format, unsigned int type, const void *row, const void *column );
GLAPI void APIENTRY glGetSeparableFilter( unsigned int target, unsigned int format, unsigned int type, void *row, void *column, void *span );

/* 1.3 functions */
GLAPI void APIENTRY glActiveTexture( unsigned int texture );
GLAPI void APIENTRY glClientActiveTexture( unsigned int texture );
GLAPI void APIENTRY glCompressedTexImage1D( unsigned int target, int level, unsigned int internalformat, int width, int border, int imageSize, const void *data );
GLAPI void APIENTRY glCompressedTexImage2D( unsigned int target, int level, unsigned int internalformat, int width, int height, int border, int imageSize, const void *data );
GLAPI void APIENTRY glCompressedTexImage3D( unsigned int target, int level, unsigned int internalformat, int width, int height, int depth, int border, int imageSize, const void *data );
GLAPI void APIENTRY glCompressedTexSubImage1D( unsigned int target, int level, int xoffset, int width, unsigned int format, int imageSize, const void *data );
GLAPI void APIENTRY glCompressedTexSubImage2D( unsigned int target, int level, int xoffset, int yoffset, int width, int height, unsigned int format, int imageSize, const void *data );
GLAPI void APIENTRY glCompressedTexSubImage3D( unsigned int target, int level, int xoffset, int yoffset, int zoffset, int width, int height, int depth, unsigned int format, int imageSize, const void *data );
GLAPI void APIENTRY glGetCompressedTexImage( unsigned int target, int lod, void *img );
GLAPI void APIENTRY glMultiTexCoord1d( unsigned int target, double s );
GLAPI void APIENTRY glMultiTexCoord1dv( unsigned int target, const double *v );
GLAPI void APIENTRY glMultiTexCoord1f( unsigned int target, float s );
GLAPI void APIENTRY glMultiTexCoord1fv( unsigned int target, const float *v );
GLAPI void APIENTRY glMultiTexCoord1i( unsigned int target, int s );
GLAPI void APIENTRY glMultiTexCoord1iv( unsigned int target, const int *v );
GLAPI void APIENTRY glMultiTexCoord1s( unsigned int target, short s );
GLAPI void APIENTRY glMultiTexCoord1sv( unsigned int target, const short *v );
GLAPI void APIENTRY glMultiTexCoord2d( unsigned int target, double s, double t );
GLAPI void APIENTRY glMultiTexCoord2dv( unsigned int target, const double *v );
GLAPI void APIENTRY glMultiTexCoord2f( unsigned int target, float s, float t );
GLAPI void APIENTRY glMultiTexCoord2fv( unsigned int target, const float *v );
GLAPI void APIENTRY glMultiTexCoord2i( unsigned int target, int s, int t );
GLAPI void APIENTRY glMultiTexCoord2iv( unsigned int target, const int *v );
GLAPI void APIENTRY glMultiTexCoord2s( unsigned int target, short s, short t );
GLAPI void APIENTRY glMultiTexCoord2sv( unsigned int target, const short *v );
GLAPI void APIENTRY glMultiTexCoord3d( unsigned int target, double s, double t, double r );
GLAPI void APIENTRY glMultiTexCoord3dv( unsigned int target, const double *v );
GLAPI void APIENTRY glMultiTexCoord3f( unsigned int target, float s, float t, float r );
GLAPI void APIENTRY glMultiTexCoord3fv( unsigned int target, const float *v );
GLAPI void APIENTRY glMultiTexCoord3i( unsigned int target, int s, int t, int r );
GLAPI void APIENTRY glMultiTexCoord3iv( unsigned int target, const int *v );
GLAPI void APIENTRY glMultiTexCoord3s( unsigned int target, short s, short t, short r );
GLAPI void APIENTRY glMultiTexCoord3sv( unsigned int target, const short *v );
GLAPI void APIENTRY glMultiTexCoord4d( unsigned int target, double s, double t, double r, double q );
GLAPI void APIENTRY glMultiTexCoord4dv( unsigned int target, const double *v );
GLAPI void APIENTRY glMultiTexCoord4f( unsigned int target, float s, float t, float r, float q );
GLAPI void APIENTRY glMultiTexCoord4fv( unsigned int target, const float *v );
GLAPI void APIENTRY glMultiTexCoord4i( unsigned int target, int s, int t, int r, int q );
GLAPI void APIENTRY glMultiTexCoord4iv( unsigned int target, const int *v );
GLAPI void APIENTRY glMultiTexCoord4s( unsigned int target, short s, short t, short r, short q );
GLAPI void APIENTRY glMultiTexCoord4sv( unsigned int target, const short *v );
GLAPI void APIENTRY glLoadTransposeMatrixd( const double m[16] );
GLAPI void APIENTRY glLoadTransposeMatrixf( const float m[16] );
GLAPI void APIENTRY glMultTransposeMatrixd( const double m[16] );
GLAPI void APIENTRY glMultTransposeMatrixf( const float m[16] );
GLAPI void APIENTRY glSampleCoverage( float value, unsigned char invert );
GLAPI void APIENTRY glSamplePass( unsigned int pass );
